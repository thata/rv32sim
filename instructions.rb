module Instructions
  ...
  def _jal(rd, imm)
    0b1101111 |
      (rd << 7) |
      (((imm & 0b1_0000_0000_0000_0000_0000) >> 20) << 31) |
      (((imm & 0b0_0000_0000_0111_1111_1110) >> 1) << 21) |
      (((imm & 0b0_0000_0000_1000_0000_0000) >> 10) << 19) |
      (((imm & 0b0_1111_1111_0000_0000_0000) >> 12) << 12)
  end
